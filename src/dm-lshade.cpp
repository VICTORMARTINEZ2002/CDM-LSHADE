...
void DMLSHADE::updateElite(const vector<double*> &pop, vector<double> &fitness, int* sorted_indexes){
	// Note que elite não está vazia!
	
	// Esse trecho de código está usando std::sort para ordenar o vetor elite,
	// que contém elementos do tipo std::tuple<double*, double>.
	// A ordenação é feita com base no segundo elemento da tupla (fitness).
